    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flip-container" style={{perspective: '1000px', transformStyle: 'preserve-3d', transition: 'transform 0.7s ease-in-out'}}>
        ...
        <div className="w-1/2 flex flex-col justify-center items-center p-12 text-white relative transform transition-all duration-700 ease-in-out">
          <button
            onClick={() => navigate('/')}
            className="absolute top-8 left-8 flex items-center gap-2 text-purple-300 hover:text-white transition-colors cursor-pointer"
          >
          ...
          <div className="max-w-lg text-center">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-yellow-400 font-medium tracking-wider uppercase text-sm">Welcome Back</span>
                <Sparkles className="w-6 h-6 text-yellow-400 animate-pulse" />
              </div>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Connect with your favorite electronics store and discover amazing deals. 
          ...
          <div className="w-full max-w-md">
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-slate-700 shadow-2xl">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-white mb-2 transition-all duration-500">Welcome Back</h3>
                <p className="text-gray-400 transition-all duration-500">Sign in to your account</p>
              </div>
              ...
              <form className="space-y-6">
                ...
                <div className="text-right">
                  <button type="button" className="text-purple-400 hover:text-purple-300 text-sm cursor-pointer">
                    Forgot password?
                  </button>
                </div>
